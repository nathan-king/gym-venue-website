      ...
      <div className={styles.main}>
        ...
        <Layout>
          <div className={styles.content}>
            <h1 className={styles.heading}>Enjoy delicious foods and beverages</h1>
            ...
            <div className={styles.imageContainer}>
                <img src="/ss-coffee-machine.jpg" alt="coffee machine" className={styles.image}/>
                <img src="/ss-spaghetti.jpg" alt="spaghetti" className={styles.image}/>
